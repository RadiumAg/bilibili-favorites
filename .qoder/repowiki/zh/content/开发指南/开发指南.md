...
## 更新摘要
**所做更改**
- 删除旧的.codebuddy规则文件支持，更新ESLint配置忽略规则
- 引入新的.clause技能文档体系，包含B站收藏夹开发规范、React最佳实践和UI/UX设计智能体
- 新增.clause技能文档的使用指南和最佳实践
...
**更新** 项目现已集成.clause AI技能文档体系，提供开发规范、React最佳实践和UI/UX设计指导，替代传统的.codebuddy规则文件。
...
M --> N["bilibili-favorites/<br/>开发规范"]
M --> O["react-best-practices/<br/>React最佳实践"]
M --> P["ui-ux-pro-max/<br/>UI/UX设计智能体"]
```
...
**更新** 新增.clause AI技能文档体系，提供开发规范、React最佳实践和UI/UX设计指导
...
## 架构总览
下图展示了开发与构建的关键交互：开发时由 Vite 启动，React 19.2.5 与 React Compiler 参与编译；构建阶段通过 @crxjs/vite-plugin 2.4.0 生成扩展清单与资源；Tailwind 与 PostCSS 处理样式；测试通过 Vitest 与 Playwright 执行；AI辅助开发通过.clause技能文档提供规范指导。
...
**更新** 删除.codebuddy规则文件支持，新增.clause AI技能文档体系
...
**更新** 所有依赖版本已更新到最新稳定版本，新增.clause AI技能文档体系
...
**更新** @crxjs/vite-plugin 升级到 2.4.0，React 版本升级到 19.2.5，新增AI技能文档故障排查
...
随着 React 升级到 19.2.5 和 @crxjs/vite-plugin 升级到 2.4.0，项目在性能和开发体验方面都有显著提升。建议团队在日常协作中坚持 ESLint + Prettier + Husky 的质量基线，结合.clause AI技能文档提供的最佳实践，以 Vitest + Playwright 保障核心功能稳定性，并持续优化构建与样式体积，确保扩展在生产环境具备良好的性能与可维护性。
