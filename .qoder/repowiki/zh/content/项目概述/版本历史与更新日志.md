...
### 版本历史与里程碑
- 1.2.2（2025.04.15）
  - **移除AI关键词提取功能**：为简化核心功能并提升稳定性，移除了AI关键词提取功能
  - **修复关键词编辑逻辑bug**：修正了关键词编辑时的键盘事件处理和删除逻辑，确保用户体验更加流畅
  - **更新项目版本号**：版本从1.2.1升级到1.2.2，保持语义化版本控制
...
### 关键词编辑逻辑修复
**更新** 1.2.2版本修复了关键词编辑的核心逻辑bug

- **键盘事件处理优化**：修正了 Enter 键和 Delete/Backspace 键的事件处理逻辑，确保关键词添加和删除的正确性
- **状态同步改进**：优化了关键词状态的更新机制，避免重复渲染和状态不一致问题
- **用户体验提升**：修复了输入框焦点管理和删除动画的流畅性问题

**章节来源**
- [src/hooks/use-edit-keyword/index.tsx](file://src/hooks/use-edit-keyword/index.tsx)

### 本地关键词提取功能
**更新** 1.2.2版本移除了AI关键词提取功能，保留本地TF-IDF算法

- **本地算法优势**：无需网络连接即可提取关键词，保护用户隐私
- **TF-IDF算法实现**：提供准确的关键词提取，支持停用词过滤和评分机制
- **性能优化**：针对中文文本的特殊处理，提高关键词提取的准确性
...
- **本地算法优化**：TF-IDF算法针对中文文本优化，提升关键词提取效率。
...
- **关键词编辑问题**：若关键词编辑出现异常，检查键盘事件绑定和状态同步机制。
...
## 结论
本项目遵循 SemVer 2.0，采用自动化发布流程，版本迭代聚焦用户体验与 AI 能力增强。通过新手引导、主题统一与流式 AI 处理，显著提升了易用性与性能。1.2.1版本的 AI 智能移动功能和完整测试覆盖进一步增强了系统的稳定性和可靠性。1.2.2版本移除了AI关键词提取功能，专注于核心功能的稳定性，并修复了关键词编辑逻辑bug，为用户提供更加可靠的本地化关键词管理体验。未来版本将持续优化本地算法、提升交互体验并加强数据安全与隐私保护。
...
- **功能变更提醒**：1.2.2版本移除了AI关键词提取功能，用户需要使用本地TF-IDF算法进行关键词提取。
...
- **本地关键词提取**：在关键词管理标签中，选择"本地算法"模式即可使用TF-IDF算法提取关键词，无需网络连接。
